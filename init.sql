...
VALUES
    ...
    (1, NOW(), 'AF-01', 1, 6.750, 839.2, 0.331, 1.30, 650.0, 2.10, 24.0),
    (1, NOW(), 'AF-01', 2, 6.750, 837.5, 0.329, 1.30, 650.0, 2.20, 24.0),
    (1, NOW(), 'AF-01', 3, 6.750, 838.8, 0.332, 1.30, 650.0, 2.15, 24.0),
    (1, NOW(), 'AF-01', 4, 6.750, 836.0, 0.328, 1.30, 650.0, 2.30, 24.0),
    (1, NOW(), 'AF-01', 5, 6.750, 838.0, 0.330, 1.30, 650.0, 2.25, 24.0),
    (1, NOW(), 'AF-01', 6, 6.750, 839.5, 0.333, 1.30, 650.0, 2.18, 24.0),
    (1, NOW(), 'AF-01', 7, 6.750, 837.0, 0.329, 1.30, 650.0, 2.22, 24.0),
    (1, NOW(), 'AF-01', 8, 6.750, 838.5, 0.331, 1.30, 650.0, 2.12, 24.0),

    -- AF-02: Lummus Ethane, feed=56 t/hr → 7.0/coil, COT=835 base
    (1, NOW(), 'AF-02', 1, 7.000, 836.2, 0.321, 1.30, 650.0, 1.80, 24.0),
    (1, NOW(), 'AF-02', 2, 7.000, 834.5, 0.319, 1.30, 650.0, 1.90, 24.0),
    (1, NOW(), 'AF-02', 3, 7.000, 835.8, 0.322, 1.30, 650.0, 1.85, 24.0),
    (1, NOW(), 'AF-02', 4, 7.000, 833.5, 0.318, 1.30, 650.0, 1.95, 24.0),
    (1, NOW(), 'AF-02', 5, 7.000, 835.0, 0.320, 1.30, 650.0, 1.88, 24.0),
    (1, NOW(), 'AF-02', 6, 7.000, 836.5, 0.323, 1.30, 650.0, 1.82, 24.0),
    (1, NOW(), 'AF-02', 7, 7.000, 834.0, 0.319, 1.30, 650.0, 1.87, 24.0),
    (1, NOW(), 'AF-02', 8, 7.000, 835.5, 0.321, 1.30, 650.0, 1.79, 24.0),

    -- AF-03: Lummus Propane, feed=76 t/hr → 9.5/coil, COT=830 base
    (1, NOW(), 'AF-03', 1, 9.500, 831.2, 0.351, 1.30, 650.0, 1.50, 24.0),
    (1, NOW(), 'AF-03', 2, 9.500, 829.5, 0.349, 1.30, 650.0, 1.60, 24.0),
    (1, NOW(), 'AF-03', 3, 9.500, 830.8, 0.352, 1.30, 650.0, 1.55, 24.0),
    (1, NOW(), 'AF-03', 4, 9.500, 828.5, 0.348, 1.30, 650.0, 1.65, 24.0),
    (1, NOW(), 'AF-03', 5, 9.500, 830.0, 0.350, 1.30, 650.0, 1.58, 24.0),
    (1, NOW(), 'AF-03', 6, 9.500, 831.5, 0.353, 1.30, 650.0, 1.52, 24.0),
    (1, NOW(), 'AF-03', 7, 9.500, 829.0, 0.349, 1.30, 650.0, 1.57, 24.0),
    (1, NOW(), 'AF-03', 8, 9.500, 830.5, 0.351, 1.30, 650.0, 1.48, 24.0),

    -- AF-04: Lummus Propane, feed=52 t/hr → 6.5/coil, COT=842 base
    (1, NOW(), 'AF-04', 1, 6.500, 843.2, 0.341, 1.30, 650.0, 2.80, 24.0),
    (1, NOW(), 'AF-04', 2, 6.500, 841.5, 0.339, 1.30, 650.0, 2.90, 24.0),
    (1, NOW(), 'AF-04', 3, 6.500, 842.8, 0.342, 1.30, 650.0, 2.85, 24.0),
    (1, NOW(), 'AF-04', 4, 6.500, 840.5, 0.338, 1.30, 650.0, 3.00, 24.0),
    (1, NOW(), 'AF-04', 5, 6.500, 842.0, 0.340, 1.30, 650.0, 2.95, 24.0),
    (1, NOW(), 'AF-04', 6, 6.500, 843.5, 0.343, 1.30, 650.0, 2.82, 24.0),
    (1, NOW(), 'AF-04', 7, 6.500, 841.0, 0.339, 1.30, 650.0, 2.88, 24.0),
    (1, NOW(), 'AF-04', 8, 6.500, 842.5, 0.341, 1.30, 650.0, 2.78, 24.0),
    ...
    (1, NOW(), 'AF-06', 1, 8.500, 833.2, 0.351, 1.30, 650.0, 1.40, 24.0),
    (1, NOW(), 'AF-06', 2, 8.500, 831.5, 0.349, 1.30, 650.0, 1.50, 24.0),
    (1, NOW(), 'AF-06', 3, 8.500, 832.8, 0.352, 1.30, 650.0, 1.45, 24.0),
    (1, NOW(), 'AF-06', 4, 8.500, 830.5, 0.348, 1.30, 650.0, 1.55, 24.0),
    (1, NOW(), 'AF-06', 5, 8.500, 832.0, 0.350, 1.30, 650.0, 1.48, 24.0),
    (1, NOW(), 'AF-06', 6, 8.500, 833.5, 0.353, 1.30, 650.0, 1.42, 24.0),
    (1, NOW(), 'AF-06', 7, 8.500, 831.0, 0.349, 1.30, 650.0, 1.47, 24.0),
    (1, NOW(), 'AF-06', 8, 8.500, 832.5, 0.351, 1.30, 650.0, 1.38, 24.0),

    -- AF-07: Lummus Propane, feed=72 t/hr → 9.0/coil, COT=828 base
    (1, NOW(), 'AF-07', 1, 9.000, 829.2, 0.361, 1.30, 650.0, 1.20, 24.0),
    (1, NOW(), 'AF-07', 2, 9.000, 827.5, 0.359, 1.30, 650.0, 1.30, 24.0),
    (1, NOW(), 'AF-07', 3, 9.000, 828.8, 0.362, 1.30, 650.0, 1.25, 24.0),
    (1, NOW(), 'AF-07', 4, 9.000, 826.5, 0.358, 1.30, 650.0, 1.35, 24.0),
    (1, NOW(), 'AF-07', 5, 9.000, 828.0, 0.360, 1.30, 650.0, 1.28, 24.0),
    (1, NOW(), 'AF-07', 6, 9.000, 829.5, 0.363, 1.30, 650.0, 1.22, 24.0),
    (1, NOW(), 'AF-07', 7, 9.000, 827.0, 0.359, 1.30, 650.0, 1.27, 24.0),
    (1, NOW(), 'AF-07', 8, 9.000, 828.5, 0.361, 1.30, 650.0, 1.18, 24.0),

    -- AF-08: Technip Ethane, feed=30 t/hr → 3.75/coil, COT=830 base
    (1, NOW(), 'AF-08', 1, 3.750, 831.2, 0.321, 1.30, 650.0, 1.00, 24.0),
    (1, NOW(), 'AF-08', 2, 3.750, 829.5, 0.319, 1.30, 650.0, 1.10, 24.0),
    (1, NOW(), 'AF-08', 3, 3.750, 830.8, 0.322, 1.30, 650.0, 1.05, 24.0),
    (1, NOW(), 'AF-08', 4, 3.750, 828.5, 0.318, 1.30, 650.0, 1.15, 24.0),
    (1, NOW(), 'AF-08', 5, 3.750, 830.0, 0.320, 1.30, 650.0, 1.08, 24.0),
    (1, NOW(), 'AF-08', 6, 3.750, 831.5, 0.323, 1.30, 650.0, 1.02, 24.0),
    (1, NOW(), 'AF-08', 7, 3.750, 829.0, 0.319, 1.30, 650.0, 1.07, 24.0),
    (1, NOW(), 'AF-08', 8, 3.750, 830.5, 0.321, 1.30, 650.0, 0.98, 24.0);
